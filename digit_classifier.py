...
my_model.compile(optimizer = 'adam', loss = 'sparse_categorical_crossentropy', metrices = ['accuracy'])
...
my_model.save('my_mnist_ model')

my_new_model = tf.keras.models.load_model('my_mnist_ model')
